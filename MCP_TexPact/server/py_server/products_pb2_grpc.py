...
class ProductServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ListProducts = channel.unary_unary(
                '/texpact.ProductService/ListProducts',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=products__pb2.ProductList.FromString,
                _registered_method=True)
        self.GetProductById = channel.unary_unary(
                '/texpact.ProductService/GetProductById',
                request_serializer=products__pb2.ProductIdRequest.SerializeToString,
...
def add_ProductServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetProductById': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=products__pb2.ProductIdRequest.FromString,
                    response_serializer=products__pb2.Product.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'texpact.ProductService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('texpact.ProductService', rpc_method_handlers)
...
class ProductService(object):
    ...
    def GetProductById(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/texpact.ProductService/GetProductById',
            products__pb2.ProductIdRequest.SerializeToString,
