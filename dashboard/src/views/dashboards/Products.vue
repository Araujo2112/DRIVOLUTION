<template>
  <div class="p-8 w-full max-w-none">
    ...
    <div v-else>
              ...
              <div class="flex items-center justify-between mb-3">
                <div>
                  <button
                    ...
                    class="text-xs font-medium text-primary-600 dark:text-primary-400 uppercase tracking-wider hover:underline"
                  >
                    {{ t('products.timeline') }}
                  </button>
      ...
      <div
        v-if="totalPages > 1"
        class="flex items-center justify-between mt-4 text-sm text-background-600 dark:text-background-400"
      >
        <span>
...
async function loadCarModels() {
  try {
    ...
    // Não bloqueia a página se a lista de modelos falhar.
  }
}
