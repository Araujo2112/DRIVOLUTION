...
def generate_manufacturing_orders() -> List[dict]:
    """
    Gera ordens de fabrico sequencialmente, associando a clientes, processos e product lots existentes.
    """
    ...
    try:
        ...
        if response.status_code in (200, 201):
            ...
            context.add_entity(
                ...
                entity_id=created_order['manufacturingOrderId'],  # URN
                entity_data=created_order,
                db_id=created_order['id']  # ID da base de dados!
            )
        return response
