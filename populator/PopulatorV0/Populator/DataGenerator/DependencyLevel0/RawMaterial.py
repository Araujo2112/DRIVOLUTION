...
def generate_raw_material(index: int) -> dict:
    """Gera dados fictícios para matéria-prima"""
...
def send_raw_material(material_data: dict) -> Optional[requests.Response]:
    """Envia a matéria-prima para a API e armazena no contexto"""
    ...
    try:
        ...
        if response.status_code in (200, 201):
            ...
            context.add_entity(
                ...
                entity_id=created_material['rawId'],  # Usando rawId como identificador
