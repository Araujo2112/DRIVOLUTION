...
def generate_item_localizations() -> List[dict]:
    """
    Gera localizações de itens, associando itens de matéria-prima e localizações de contentores.
    """
    # IDs inteiros das entidades já criadas
    ...
    try:
        ...
        if response.status_code in (200, 201):
            ...
            context.add_entity(
                ...
                entity_id=created_localization['itemLocalizationId'],  # ID da base de dados!
