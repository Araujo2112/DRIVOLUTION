...
from Populator.DataGenerator.DependenctLevel2.ManufacturingOrder import generate_manufacturing_orders, \
    send_manufacturing_order
from Populator.DataGenerator.DependenctLevel2.ManufacturingProcessPhase import generate_manufacturing_process_phases, \
    send_manufacturing_process_phase
from Populator.DataGenerator.DependencyLevel0.Client import generate_client, send_client
from Populator.DataGenerator.DependencyLevel0.Container import generate_container, send_container
from Populator.DataGenerator.DependencyLevel0.PlantFloorSection import generate_plant_floor_section, \
    send_plant_floor_section
from Populator.DataGenerator.DependencyLevel0.Product import generate_product, send_product
from Populator.DataGenerator.DependencyLevel0.RawMaterial import generate_raw_material, send_raw_material
from Populator.DataGenerator.DependencyLevel1.Checkpoint import generate_checkpoints, send_checkpoint
from Populator.DataGenerator.DependencyLevel1.ContainerLocalization import generate_container_localization_histories, \
    send_container_localization_history
from Populator.DataGenerator.DependencyLevel1.ItemInContainer import generate_items_in_container, send_item_in_container
from Populator.DataGenerator.DependencyLevel1.LotOfRawMaterial import generate_lots_of_raw_material, \
    send_lot_of_raw_material
from Populator.DataGenerator.DependencyLevel1.ManufacturingPhases import generate_manufacturing_phases, \
    send_manufacturing_phase
from Populator.DataGenerator.DependencyLevel1.ManufacturingProcess import generate_manufacturing_processes, \
    send_manufacturing_process
from Populator.DataGenerator.DependencyLevel1.ProductLots import generate_product_lots, send_product_lot
from Populator.DataGenerator.DependencyLevel3.ManufacturingOrderHistory import generate_manufacturing_order_histories, \
...
from Populator.DataGenerator.DependencyLevel5.ItemLocalization import generate_item_localizations, \
...
try:
    # Gere, por exemplo, 10 localizações
...
try:
    ...
    for localization in all_localizations:
        ...
        if response and response.status_code in (200, 201):
            res_data = response.json()
            print(f"ItemLocalization criada: ItemRawId {localization['itemRawId']} | ContainerLocalizationId {localization['containerLocalizationId']} | ID DB: {res_data['itemLocalizationId']}")
        else:
