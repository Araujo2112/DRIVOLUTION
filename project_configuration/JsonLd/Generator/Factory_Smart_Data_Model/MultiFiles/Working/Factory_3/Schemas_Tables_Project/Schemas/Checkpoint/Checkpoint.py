...
#   timestamp: 2024-12-04T23:53:59+00:00
...
class DataModelPlataform(GSMACommons):
    id: str = Field(..., description='Property. Unique identifier for the Checkpoint')
    type: Type = Field(..., description='Property. It has to be Checkpoint')
    name: Optional[str] = Field(None, description='Property. Name of the Checkpoint')
    description: Optional[str] = Field(
        None, description='Property. Status of the Checkpoint'
    )
