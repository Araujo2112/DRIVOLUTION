...
#   timestamp: 2024-12-04T23:55:02+00:00
...
class DataModelPlataform(GSMACommons):
    ...
    type: Type = Field(..., description='Property. It has to be Container')
    name: Optional[str] = Field(None, description='Property. Name of the container')
