...
#   filename:  ItemInContainer.json
#   timestamp: 2024-12-04T23:51:25+00:00
...
class DataModelPlataform(GSMACommons):
    id: str = Field(
        ..., description='Property. Unique identifier for the Item in Container'
    )
    type: Type = Field(..., description='Property. It has to be Time')
    dateTimeIn: Optional[datetime] = Field(
        None, description='Property. DateTime In of the Container'
    )
    dateTimeOut: Optional[datetime] = Field(
        None, description='Property. DateTime Out of the Container'
    )
