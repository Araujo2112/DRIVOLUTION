...
#   filename:  ItemOfRawMaterial.json
#   timestamp: 2024-12-05T00:12:14+00:00
...
class DataModelPlataform(GSMACommons):
    id: str = Field(..., description='Property. Unique identifier for lot item')
    type: Type = Field(..., description='Property. It has to be ItemOfRawMaterial')
    quantity: Optional[float] = Field(
        None, description='Property. Quantity of raw material itens'
    )
    unit: Optional[str] = Field(None, description='Property. Unit of itens in lot')
