...
#   filename:  LotOfRawMaterial.json
#   timestamp: 2024-12-05T00:07:10+00:00
...
class Type(Enum):
    LotOfRawMaterial = 'LotOfRawMaterial'
...
class EntityIdentifierType(BaseModel):
    __root__: Union[
        ...
        AnyUrl,
    ] = Field(..., description='Relationship. Unique identifier of the entity')


class Email(BaseModel):
    __root__: EmailStr = Field(..., description='Property. Email address of owner')


class UserAlias(BaseModel):
    __root__: str = Field(..., description='Property. An anonymous alias of a user')
...
class DateYearLess(BaseModel):
    __root__: constr(
        regex=r'^--((0[13578]|1[02])-31|(0[1,3-9]|1[0-2])-30|(0\d|1[0-2])-([0-2]\d))$'
    )
...
class OpeningHoursSpecificationItem(BaseModel):
    ...
    validFrom: Optional[Union[date, datetime]] = Field(
        None,
        description='Property. The date when the item becomes valid. A date value in the form CCYY-MM-DD or a combination of date and time of day in the form [-]CCYY-MM-DDThh:mm:ss[Z|(+|-)hh:mm] in ISO 8601 date format',
    )
    validThrough: Optional[Union[date, datetime]] = Field(
        None,
...
class ExtensibleCommons(BaseModel):
    Addressable: Optional[Addressable] = Field(
        None, description='Property. Base schema for addressable entities'
    )
    Extensible: Optional[Extensible] = Field(
        None,
...
class IsAccessibleForFree(BaseModel):
    __root__: bool = Field(
        ...,
...
class AvailableLanguage(BaseModel):
    __root__: List[AvailableLanguageEnum] = Field(
        ...,
...
class DataModelPlataform(GSMACommons):
    id: str = Field(..., description='Property. Unique identifier for the Material Lot')
    type: Type = Field(..., description='Property. It has to be LotOfRawMaterial')
    lotNumber: Optional[str] = Field(
        None, description='Property. Lot number of Material'
    )
    lotQuantity: Optional[float] = Field(
        None, description='Property. Quantity of Material'
    )
    lotUnit: Optional[str] = Field(None, description='Property. Unit of Material')
