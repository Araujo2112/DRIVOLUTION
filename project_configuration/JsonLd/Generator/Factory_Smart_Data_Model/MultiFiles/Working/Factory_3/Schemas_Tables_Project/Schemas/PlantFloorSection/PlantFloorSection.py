...
#   filename:  PlantFloorSection.json
#   timestamp: 2024-12-04T23:55:23+00:00
...
class DataModelPlataform(GSMACommons):
    id: str = Field(..., description='Property. Unique identifier for the Section')
    type: Type = Field(..., description='Property. It has to be Section')
    name: Optional[str] = Field(None, description='Property. Name of the Section')
    statusName: Optional[bool] = Field(
        None, description='Property. Status of the Section'
    )
